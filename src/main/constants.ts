...
const slipperDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(slipperDir, "Uninstall Slipper.exe"));

export const DATA_DIR =
    process.env.SLIPCORD_USER_DATA_DIR || (PORTABLE ? join(slipperDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Slipper/${app.getVersion()} (https://github.com/slipcords/Slipper)`;

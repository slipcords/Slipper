...
VesktopLogger.log(`Slipper v${VesktopNative.app.getVersion()}`);

const { customEntries, customSections } = Vencord.Plugins.plugins.Settings as any as typeof SettingsPlugin;

customEntries.push({
    key: "slipcord_slipper_settings",
    title: "Slipper Settings",
    Component: SettingsUi,
    Icon: VesktopSettingsIcon
});

customSections.push(() => ({
    section: "SlipperSettings",
    label: "Slipper Settings",
    element: SettingsUi,
    className: "vc-slipper-settings"
}));
